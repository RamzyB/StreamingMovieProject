...
class Movie(models.Model):
    ...
    world_premiere = models.DateField('Премьера в фильме')
    budget = models.PositiveIntegerField('Бюджет', default=0, help_text='Необходимо указать сумму в долларах')
    fees_in_usa = models.PositiveIntegerField(
        'Сборы в США', default=0, help_text='Необходимо указать сумму в долларах')
    fees_in_world = models.PositiveIntegerField(
        'Сборы в мире', default=0, help_text='Необходимо указать сумму в долларах')
